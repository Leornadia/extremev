        ...
        <Container>
          <div className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center gap-4">
              ...
              {/* Find My Playset CTA - Desktop Only */}
              <Link
                href="/find-my-playset"
                className="hidden md:flex items-center gap-2 px-4 py-2.5 rounded-full bg-gradient-to-r from-primary-500 to-primary-600 text-white font-semibold text-sm hover:from-primary-600 hover:to-primary-700 transform transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
              >
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
                ...
                <span className="hidden lg:inline">Find My Playset</span>
                <span className="lg:hidden">3D Preview</span>
              </Link>
